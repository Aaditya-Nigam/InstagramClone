            ...
            <div>
                <div className="px-16 pt-2 pb-8 border-1 rounded flex flex-col items-center border-[rgb(85,85,85)] gap-2">  
                    ...
                    <form className="flex flex-col gap-3" onSubmit={handleFormSubmit}>
                        ...
                        <button type="submit" className="bg-sky-500 rounded-lg py-1 text-lg cursor-pointer hover:bg-sky-600" disabled={isLoggingIn}>Log in</button>
                    </form>
                    <NavLink className="text-md text-zinc-400 hover:text-zinc-300">Forgotten your password?</NavLink>
                    <p>Don't have an account? <NavLink to="/signUp" className="text-sky-700 hover:underline hover:text-sky-500">Sign up</NavLink></p>
                </div>
            </div>
            <Toaster/>
        </main>
